...
export const translations = {
    ...
    'app.tagline': { vi: 'Bảo vệ Dòng chảy công việc của bạn', en: 'Protect your workflow' },
    'app.description': { vi: 'Hệ thống quản lý công việc bảo vệ Flow State qua giới hạn WIP', en: 'Task management system protecting Flow State via WIP limits' },
    ...
    'auth.registering': { vi: 'Đang tạo tài khoản...', en: 'Creating account...' },
    'auth.createAccount': { vi: 'Tạo tài khoản mới', en: 'Create new account' },

    // ============================================
    // Vai trò / Roles
    // ============================================
    'role.maker': { vi: 'Thực thi (Developer/Designer)', en: 'Maker (Developer/Designer)' },
    'role.manager': { vi: 'Quản lý (PM/Lead)', en: 'Manager (PM/Lead)' },
    'role.observer': { vi: 'Quan sát (Stakeholder)', en: 'Observer (Stakeholder)' },
    ...
    'dashboard.tasksTriage': { vi: 'công việc đang chờ phân loại', en: 'tasks awaiting triage' },
    'dashboard.doingTasks': { vi: 'Công việc đang thực hiện', en: 'Tasks in progress' },
    'dashboard.viewBoard': { vi: 'Xem bảng →', en: 'View board →' },
    'dashboard.noDoingTasks': { vi: 'Chưa có công việc nào đang làm', en: 'No tasks in progress' },
    'dashboard.cycleProgress': { vi: 'Tiến độ chu kỳ', en: 'Cycle Progress' },
    'dashboard.details': { vi: 'Chi tiết →', en: 'Details →' },
    'dashboard.newNotifications': { vi: 'Thông báo mới', en: 'New notifications' },
    ...
    'board.subtitle': { vi: 'Kéo thả công việc giữa các cột', en: 'Drag and drop tasks between columns' },
    ...
    'focus.selectTask': { vi: 'Chọn công việc và bắt đầu tập trung', en: 'Select a task to start focusing' },
    'focus.noDoingTasks': { vi: 'Chưa có công việc nào đang thực hiện', en: 'No tasks currently in progress' },
    'focus.moveToBoard': { vi: 'Chuyển công việc từ Sẵn sàng sang Đang làm trước', en: 'Move a task from Ready to Doing first' },
    ...
    'quarantine.subtitle': { vi: 'Công việc cần phân loại: khẩn cấp, deadline không khả thi, hoặc bị đánh dấu', en: 'Tasks needing triage: urgent, infeasible deadline, or flagged' },
    'quarantine.empty': { vi: 'Vùng cách ly trống', en: 'Quarantine zone is empty' },
    'quarantine.noTriage': { vi: 'Không có công việc nào cần phân loại', en: 'No tasks need triage' },
    'quarantine.tradeOff': { vi: 'Đánh đổi', en: 'Trade-off' },
    'quarantine.defer': { vi: 'Hoãn lại', en: 'Defer' },
    'quarantine.reject': { vi: 'Từ chối', en: 'Reject' },
    'quarantine.deferToReady': { vi: '→ Chuyển sang Sẵn sàng (ưu tiên cao)', en: '→ Move to Ready (high priority)' },
    'quarantine.deferToBacklog': { vi: '→ Chuyển sang Chờ xử lý', en: '→ Move to Backlog' },
    'quarantine.tradeOffTitle': { vi: 'Chọn công việc để hoán đổi', en: 'Select a task to swap' },
    'quarantine.tradeOffDesc': { vi: 'Bạn đã đạt giới hạn WIP. Chọn 1 công việc đang làm để hoán đổi ra.', en: 'You\'ve reached WIP limit. Select a task to swap out.' },
    'quarantine.swapConfirm': { vi: 'Xác nhận hoán đổi', en: 'Confirm swap' },
    'quarantine.cancel': { vi: 'Huỷ', en: 'Cancel' },
    'quarantine.swapSuccess': { vi: 'Đã hoán đổi thành công!', en: 'Swap successful!' },
    'quarantine.deferSuccess': { vi: 'Đã hoãn công việc', en: 'Task deferred' },
    'quarantine.rejectSuccess': { vi: 'Đã từ chối công việc', en: 'Task rejected' },
    ...
    'projects.subtitle': { vi: 'Quản lý các dự án trong chu kỳ', en: 'Manage projects in cycle' },
    ...
    'cycles.subtitle': { vi: 'Chu kỳ 12 tuần — Kế hoạch theo giai đoạn', en: '12-Week Cycles — Phase-based planning' },
    ...
    'analytics.subtitle': { vi: 'Số liệu & thông tin chi tiết cho Quản lý', en: 'Metrics & insights for Managers' },
    ...
    'analytics.statusBreakdown': { vi: 'Phân bổ theo trạng thái', en: 'Status breakdown' },
    ...
    'settings.subtitle': { vi: 'Quản lý tài khoản và cài đặt hệ thống', en: 'Manage account and system settings' },
    'settings.general': { vi: 'Cài đặt chung', en: 'General settings' },
    'settings.generalDesc': { vi: 'Giao diện, ngôn ngữ, múi giờ, thông báo', en: 'Theme, language, timezone, notifications' },
    'settings.team': { vi: 'Quản lý nhóm', en: 'Team management' },
    'settings.teamDesc': { vi: 'Thành viên, vai trò, phân quyền', en: 'Members, roles, permissions' },
    'settings.wip': { vi: 'Quy tắc WIP', en: 'WIP Rules' },
    'settings.wipDesc': { vi: 'Giới hạn WIP, quy tắc ghi đè, hệ số Hofstadter', en: 'WIP limits, override rules, Hofstadter coefficient' },
    ...
    'settings.backToSettings': { vi: '← Quay lại Cài đặt', en: '← Back to Settings' },
    ...
    'wip.maxDoing': { vi: 'Số công việc Đang làm tối đa', en: 'Max simultaneous Doing tasks' },
    'wip.allowOverride': { vi: 'Cho phép Quản lý ghi đè giới hạn WIP', en: 'Allow Manager to override WIP limit' },
    'wip.hofstadter': { vi: 'Hệ số Hofstadter', en: 'Hofstadter Multiplier' },
    'wip.defaultCoeff': { vi: 'Hệ số mặc định', en: 'Default coefficient' },
    'wip.formula': { vi: 'thời_lượng_dự_kiến = nỗ_lực × Hofstadter', en: 'scheduled_duration = effort × Hofstadter' },
    ...
    'templates.subtitle': { vi: 'Tạo công việc nhanh từ các mẫu có sẵn', en: 'Quickly create tasks from predefined templates' },
    ...
    'search.placeholder': { vi: 'Tìm công việc, dự án, người...', en: 'Search tasks, projects, people...' },
    'search.headerPlaceholder': { vi: 'Tìm kiếm... (⌘K)', en: 'Search... (⌘K)' },
    'search.results': { vi: 'kết quả cho', en: 'results for' },
    'search.minChars': { vi: 'Nhập ít nhất 2 ký tự để tìm kiếm', en: 'Enter at least 2 characters to search' },

    // ============================================
    // Xử lý nhanh / Quick Strike
    // ============================================
    'quickStrike.placeholder': { vi: 'Xử lý nhanh... (≤ 2 phút)', en: 'Quick Strike... (≤ 2 min)' },
    ...
    'notifications.markAllRead': { vi: 'Đánh dấu tất cả đã đọc', en: 'Mark all as read' },
    'notifications.empty': { vi: 'Không có thông báo mới', en: 'No new notifications' },
    'notifications.allCaughtUp': { vi: 'Bạn đã xem hết thông báo!', en: 'You\'re all caught up!' },
    ...
    'common.notFoundDesc': { vi: 'Trang bạn tìm kiếm không tồn tại hoặc đã bị di chuyển.', en: 'The page you are looking for does not exist or has been moved.' },
    'common.goHome': { vi: '← Về trang chủ', en: '← Go home' },
    'common.error': { vi: 'Đã xảy ra lỗi', en: 'An error occurred' },
    'common.errorDefault': { vi: 'Đã xảy ra lỗi không mong muốn. Vui lòng thử lại.', en: 'An unexpected error occurred. Please try again.' },
