...
const templates = [
    { name: 'Báo giá (Mẫu chuẩn)', type: 'quotation', content: extractTemplate('quotation-template.ts'), variables: ['quotation_number','day','month','year','customer_company','customer_representative_title','customer_representative','customer_position','customer_address','customer_phone','customer_mobile','customer_tax_code','customer_email','quotation_items_table','subtotal','vat_rate','vat_amount','total_amount_number','amount_in_words','payment_terms','delivery_time','delivery_address'], is_default: true },
    { name: 'Hợp đồng dịch vụ (Mẫu chuẩn)', type: 'contract', content: extractTemplate('contract-template.ts', 'contractSoftwareTemplate'), variables: ['contract_number','day','month','year','customer_company','customer_representative_title','customer_representative','customer_position','customer_address','customer_phone','customer_mobile','customer_tax_code','customer_email','contract_items_table','subtotal','vat_rate','vat_amount','total_amount_number','amount_in_words','payment_terms','delivery_time','end_date','delivery_address','service_description','warranty_clause_html','contract_clause_count','contract_title_upper','contract_title_body'], is_default: true },
    { name: 'Hợp đồng dịch vụ trường học / giáo dục (Mẫu chuẩn)', type: 'contract', content: extractTemplate('contract-template.ts', 'contractSchoolTemplate'), variables: ['contract_number','day','month','year','customer_company','customer_representative_title','customer_representative','customer_position','customer_address','customer_phone','customer_mobile','customer_tax_code','customer_email','contract_items_table','subtotal','vat_rate','vat_amount','total_amount_number','amount_in_words','payment_terms','delivery_time','end_date','delivery_address','service_description','warranty_clause_html','contract_clause_count','contract_title_upper','contract_title_body'], is_default: true },
    { name: 'Hợp đồng thiết kế & in ấn (Mẫu chuẩn)', type: 'contract', content: extractTemplate('contract-template.ts', 'contractDesignTemplate'), variables: ['contract_number','day','month','year','customer_company','customer_representative_title','customer_representative','customer_position','customer_address','customer_phone','customer_mobile','customer_tax_code','customer_email','contract_items_table','subtotal','vat_rate','vat_amount','total_amount_number','amount_in_words','payment_terms','delivery_time','end_date','delivery_address','service_description','warranty_clause_html','contract_clause_count','contract_title_upper','contract_title_body','design_review_days','design_review_rounds','video_review_days','video_review_rounds','print_review_days'], is_default: true },
    { name: 'Đơn đặt hàng (Mẫu chuẩn)', type: 'order', content: extractTemplate('order-template.ts'), variables: ['order_number','day','month','year','customer_company','customer_representative_title','customer_representative','customer_position','customer_address','customer_phone','customer_mobile','customer_tax_code','customer_email','contract_items_table','subtotal','vat_rate','vat_amount','total_amount_number','amount_in_words','payment_terms','delivery_time','delivery_address'], is_default: true },
    ...
    { name: 'Biên bản giao nhận (Mẫu chuẩn)', type: 'delivery_minutes', content: extractTemplate('delivery-minutes-template.ts'), variables: ['report_number','day','month','year','customer_company','customer_representative_title','customer_representative','customer_position','customer_address','customer_phone','customer_mobile','customer_tax_code','customer_email','contract_number','order_number','order_date','delivery_items_table'], is_default: true },
