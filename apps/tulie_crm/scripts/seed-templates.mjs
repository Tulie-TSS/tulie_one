...
const templates = [
    ...
    { name: 'Hợp đồng CTV (Mẫu chuẩn)', type: 'freelance_contract', content: extractTemplate('freelance-template.ts'), variables: ['contract_number', 'day', 'month', 'year', 'freelancer_name', 'freelancer_cccd', 'cccd_date', 'cccd_place', 'freelancer_dob', 'freelancer_address', 'freelancer_contact_address', 'freelancer_phone', 'freelancer_email', 'freelancer_bank_account', 'freelancer_bank_account_name', 'freelancer_bank_name', 'project_name', 'start_date', 'end_date', 'total_amount', 'deposit_amount', 'deposit_percent', 'remaining_amount', 'termination_penalty_percent', 'notice_days', 'amount_in_words', 'contract_items_table_no_vat', 'total_amount_number'], is_default: true },
]
