    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-border">
                <div className="flex items-center gap-2 text-[11px] text-muted-foreground bg-muted px-3 py-1.5 rounded-full border border-border">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    ...
                    <Button 
                        ...
                        className="flex-1 sm:flex-initial px-8 h-11 bg-zinc-950 hover:bg-zinc-800 text-white rounded-md shadow-xl shadow-zinc-950/10 text-[11px] transition-all active:scale-[0.98]"
                    >
