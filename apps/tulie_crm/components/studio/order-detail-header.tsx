        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-border">
                    ...
                    <div className="flex items-center gap-3 mb-1">
                        <h1 className="text-2xl text-foreground flex items-center gap-1.5">
                            ...
                            <button
                                ...
                                className="text-zinc-300 hover:text-muted-foreground transition-colors"
                            >
                    ...
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-sm text-muted-foreground font-normal">
                        ...
                        {order.customer_phone && (
                            <>
                                ...
                                <span className="font-medium text-muted-foreground">{order.customer_phone}</span>
                            </>
                        )}
                        <span className="h-1 w-1 rounded-full bg-zinc-300" />
            ...
            <div className="flex items-center gap-2.5">
                ...
                <Button
                    ...
                    size="sm"
                    asChild
                    className="h-9 rounded-lg font-medium text-xs bg-muted text-zinc-700 hover:bg-primary/5 hover:text-primary transition-all border border-border"
                >
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" size="icon" className="h-9 w-9 rounded-lg border border-border hover:bg-muted">
                    ...
                    <DropdownMenuContent align="end" className="w-64 rounded-md border-border shadow-lg p-1">
                        ...
                        {statusFlow.map((status) => (
                            ...
                            >
                                ...
                                {status === order.order_status && <span className="ml-auto text-[11px] text-muted-foreground font-medium">Hiện tại</span>}
                            </DropdownMenuItem>
                        ))}
