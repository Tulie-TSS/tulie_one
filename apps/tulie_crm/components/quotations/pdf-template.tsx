        ...
        <Document title={`Bao gia ${quotation.quotation_number || ''}`}>
            <Page size="A4" style={styles.page}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 40, alignItems: 'flex-start' }}>
                    ...
                    <View style={{ width: '60%' }}>
                        <Text style={{ fontSize: 13, fontFamily: 'Roboto-Bold', color: '#000', marginBottom: 6, textTransform: 'none' }}>
                    ...
                    <View style={{ width: '35%', textAlign: 'right' }}>
                        <Text style={{ fontSize: 42, fontFamily: 'Roboto-Bold', color: '#000', letterSpacing: -1, textTransform: 'none', lineHeight: 0.8 }}>Báo giá</Text>
                ...
                <View style={{ marginBottom: 30, backgroundColor: '#fcfcfc', padding: 15, borderRadius: 8, border: '1px solid #efefef' }}>
                    <Text style={{ fontSize: 9, color: '#888', textTransform: 'none', marginBottom: 6, fontFamily: 'Roboto-Bold' }}>Thông tin khách hàng / Customer:</Text>
                ...
                {hasProposal && (
                    <View style={{ marginBottom: 30 }}>
                        <View style={{ backgroundColor: '#000', padding: 10, borderRadius: 4, marginBottom: 15 }}>
                            <Text style={{ color: '#fff', fontSize: 11, fontFamily: 'Roboto-Bold', textTransform: 'none' }}>Đề xuất giải pháp / Proposal</Text>
                        </View>
                                ...
                                return pc.sections.filter((s: any) => s.label && s.content && s.content.trim()).map((s: any, idx: number) => (
                                    <View key={s.key || idx} wrap={false} style={{ marginBottom: 15, paddingLeft: 15, borderLeft: '2px solid #efefef' }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 4 }}>
                                            ...
                                            <Text style={{ fontSize: 10, fontFamily: 'Roboto-Bold', textTransform: 'none' }}>{s.label}</Text>
                                        </View>
                                ...
                                return (
                                    <View key={key} wrap={false} style={{ marginBottom: 15, paddingLeft: 15, borderLeft: '2px solid #efefef' }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 4 }}>
                                            ...
                                            <Text style={{ fontSize: 10, fontFamily: 'Roboto-Bold', textTransform: 'none' }}>{labels[key] || key}</Text>
                                        </View>
                        ...
                        <View key={sectionIdx} wrap={false}>
                            ...
                            {(sectionName !== DEFAULT_SECTION || sectionEntries.length > 1) && (
                                <View style={{ backgroundColor: '#f9f9f9', padding: 8, borderBottom: '1px solid #efefef' }}>
                                    <Text style={{ fontSize: 9, fontFamily: 'Roboto-Bold', textTransform: 'none' }}>{sectionName}</Text>
                                </View>
                            )}
                ...
                <View style={{ marginTop: 40, flexDirection: 'row', gap: 30 }}>
                    ...
                    <View style={{ width: '40%', padding: 12, backgroundColor: '#fcfcfc', borderRadius: 8, border: '1px solid #efefef' }}>
                        <Text style={{ fontSize: 9, fontFamily: 'Roboto-Bold', marginBottom: 8, textTransform: 'none', textAlign: 'center' }}>Thông tin thanh toán</Text>
                        <View style={{ gap: 4 }}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
