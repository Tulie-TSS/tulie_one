...
export async function GET(
  ...
  <table style="width:100%; border-collapse:collapse; margin-bottom: 12px; font-size:9.5pt;">
    <tr>
      ...
      <td style="padding:4px 0;"><span style="font-weight:bold;">[✓]</span> Đạt yêu cầu kỹ thuật & Responsive &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#888;">[ ]</span> Chưa đạt</td>
    </tr>
    <tr>
      <td style="font-weight:bold; padding:4px 0;">- Chức năng hệ thống (Feature):</td>
      <td style="padding:4px 0;"><span style="font-weight:bold;">[✓]</span> Đạt yêu cầu vận hành theo hợp đồng &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#888;">[ ]</span> Chưa đạt</td>
    </tr>
    <tr>
      <td style="font-weight:bold; padding:4px 0;">- Quản trị nội dung (CMS/Backend):</td>
      <td style="padding:4px 0;"><span style="font-weight:bold;">[✓]</span> Đạt yêu cầu cập nhật & Phân quyền &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#888;">[ ]</span> Chưa đạt</td>
    </tr>
    <tr>
      <td style="font-weight:bold; padding:4px 0;">- Tối ưu SEO & Tốc độ tải trang:</td>
      <td style="padding:4px 0;"><span style="font-weight:bold;">[✓]</span> Đạt chỉ số cam kết (Lighthouse) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#888;">[ ]</span> Chưa đạt</td>
    </tr>
  </table>`
            )
