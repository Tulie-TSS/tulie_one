    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[50vh] gap-6 text-center px-4">
            ...
            <div className="space-y-1 max-w-sm">
                <h2 className="text-lg font-semibold">Không tải được danh sách hợp đồng</h2>
                <p className="text-sm text-muted-foreground">
                    Vui lòng thử lại. Nếu lỗi tiếp diễn, liên hệ kỹ thuật.
                </p>
                {error.digest && (
                    <p className="text-xs text-muted-foreground/50 font-mono mt-2">ID: {error.digest}</p>
                )}
            </div>
