            ...
            <div className="space-y-6 max-w-[1600px] mx-auto w-full pb-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/40 pb-5">
                    <div className="flex flex-col gap-0.5">
                        <h1 className="text-2xl font-bold tracking-tight text-foreground">Dòng tiền</h1>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <Card glow="emerald" className="border border-border/50 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.03)]">
                        <CardContent className="p-4 flex flex-col justify-between min-h-[100px]">
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-semibold text-muted-foreground tracking-wide">Tổng tiền vào</span>
                            ...
                            <div className="mt-1 flex-1 flex flex-col justify-end">
                                <h3 className="text-lg font-bold text-emerald-600 tracking-tight leading-none">{formatCurrency(totalInflow)}</h3>
                    ...
                    <Card glow="coral" className="border border-border/50 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.03)]">
                        <CardContent className="p-4 flex flex-col justify-between min-h-[100px]">
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-semibold text-muted-foreground tracking-wide">Tổng tiền ra</span>
                            ...
                            <div className="mt-1 flex-1 flex flex-col justify-end">
                                <h3 className="text-lg font-bold text-orange-600 tracking-tight leading-none">{formatCurrency(totalOutflow)}</h3>
                                <div className="mt-2 text-[10px] text-muted-foreground border-t border-border/40 pt-1.5 leading-snug font-semibold">
                    ...
                    <Card glow={netCashFlow >= 0 ? "emerald" : "coral"} className="border border-border/50 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.03)]">
                        <CardContent className="p-4 flex flex-col justify-between min-h-[100px]">
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-semibold text-muted-foreground tracking-wide">Số dư ròng</span>
                            ...
                            <div className="mt-1 flex-1 flex flex-col justify-end">
                                <h3 className={cn("text-lg font-bold tracking-tight leading-none", netCashFlow >= 0 ? "text-emerald-600" : "text-red-600")}>
                    ...
                    <Card glow="blue" className="border border-border/50 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.03)]">
                        <CardContent className="p-4 flex flex-col justify-between min-h-[100px]">
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-semibold text-muted-foreground tracking-wide">Tháng gần nhất</span>
                                <div className="p-1 rounded-lg border bg-blue-50 border-blue-100 shrink-0">
                                    <Activity className="size-3.5 text-blue-500" />
                                </div>
                            </div>
                            <div className="mt-1 flex-1 flex flex-col justify-end">
                                <h3 className={cn("text-lg font-bold tracking-tight leading-none", (lastMonth?.net || 0) >= 0 ? "text-foreground" : "text-red-600")}>
