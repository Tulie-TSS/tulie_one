                    ...
                    <Card className="rounded-md border-border">
                        ...
                        <CardContent className="space-y-6">
                            <div className="flex justify-between items-end">
                                ...
                                <div className={`text-2xl tabular-nums ${progress >= 100 ? 'text-emerald-600' : 'text-primary'}`}>
                                    {progress.toFixed(0)}%
                                </div>
                            </div>
                            <Progress value={Math.min(progress, 100)} className="h-3 rounded-full bg-muted" />
                            <div className="flex items-center gap-2 text-xs text-muted-foreground font-medium bg-muted p-3 rounded-lg border border-border">
