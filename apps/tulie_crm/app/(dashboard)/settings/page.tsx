    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-md bg-zinc-950 flex items-center justify-center  transition-transform hover:scale-105 duration-300">
                    <Settings className="h-6 w-6 text-white" />
                </div>
                <div>
                    <h1 className="text-3xl text-foreground">Cài đặt</h1>
            ...
            <Tabs defaultValue="company" onValueChange={loadTabData} className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1 max-w-4xl">
                        ...
                        <Card className="rounded-md border-border overflow-hidden">
                            ...
                            <CardContent className="space-y-6 pt-6">
                                ...
                                <div className="flex justify-end pt-2">
                                    <Button onClick={handleSaveCompanySettings} disabled={isSavingCompany} className="rounded-md px-8">
                            ...
                            <CardContent className="space-y-6 pt-6">
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex items-end">
                                        <Button onClick={handleAddCategory} disabled={isAddingCategory} className="h-11 rounded-md px-6">
                                ...
                                <div className="border border-border rounded-md divide-y divide-border/50 overflow-hidden">
                    ...
                    <TabsContent value="units">
                        <Card className="rounded-md border-border overflow-hidden">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                <CardTitle className="text-xl">Đơn vị tính (ĐVT)</CardTitle>
                                <CardDescription className="text-sm font-medium">
                            ...
                            <CardContent className="space-y-6 pt-6">
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex items-end">
                                        <Button onClick={handleAddUnit} disabled={isSavingUnits} className="h-11 rounded-md px-6">
                                            <Plus className="h-4 w-4" />
                                            Thêm
                                        </Button>
                                    </div>
                    ...
                    <TabsContent value="brands">
                        <Card className="rounded-md border-border overflow-hidden">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                <CardTitle className="text-xl">Danh mục Thương hiệu</CardTitle>
                                <CardDescription className="text-sm font-medium">
                            ...
                            <CardContent className="space-y-6 pt-6">
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex items-end">
                                        <Button onClick={handleAddBrand} disabled={isSavingBrands} className="h-11 rounded-md px-6">
                                            <Plus className="h-4 w-4" />
                                            Thêm
                                        </Button>
                                    </div>
                    ...
                    <TabsContent value="statuses">
                        <div className="grid gap-6">
                            <Card className="rounded-md border-border overflow-hidden">
                                <CardHeader className="bg-muted/30 border-b border-border">
                                    <CardTitle className="text-xl">Trạng thái Khách hàng</CardTitle>
                                        ...
                                        {['lead', 'prospect', 'customer', 'vip', 'churned'].map((status) => (
                                            <div key={status} className="flex items-center justify-between p-4 border border-border rounded-md hover:bg-muted/20 transition-colors">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <span className="text-xs text-muted-foreground font-medium">Quy trình bán hàng tiêu chuẩn</span>
                                                </div>
                                                <Button variant="ghost" size="sm" disabled className="text-xs text-muted-foreground">Hệ thống</Button>
                                            </div>
                                        ))}
                                    </div>
                                </CardContent>
                            ...
                            <Card className="rounded-md border-border overflow-hidden">
                                <CardHeader className="bg-muted/30 border-b border-border">
                                    <CardTitle className="text-xl">Trạng thái Báo giá</CardTitle>
                                        ...
                                        {['draft', 'sent', 'viewed', 'accepted', 'rejected', 'expired', 'converted'].map((status) => (
                                            <div key={status} className="flex items-center justify-between p-4 border border-border rounded-md hover:bg-muted/20 transition-colors">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <span className="text-xs text-muted-foreground font-medium">Quy trình duyệt báo giá</span>
                                                </div>
                                                <Button variant="ghost" size="sm" disabled className="text-xs text-muted-foreground">Hệ thống</Button>
                                            </div>
                                        ))}
                        ...
                        <Card className="rounded-md border-border overflow-hidden">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                <div className="flex items-center gap-3">
                                    <div className="w-10 rounded-md bg-zinc-950 flex items-center justify-center ">
                                        <Send className="h-5 w-5 text-white" />
                                    </div>
                                    <div>
                                        <CardTitle className="text-xl">Cấu hình Telegram Bot</CardTitle>
                                        <CardDescription className="text-sm font-medium">
                            ...
                            <CardContent className="space-y-8 pt-6">
                                <div className="flex items-center justify-between p-5 bg-muted/30 rounded-md border border-border">
                                    <div className="space-y-0.5">
                                        <Label className="text-base text-foreground">Kích hoạt thông báo</Label>
                                ...
                                <div className="p-5 rounded-md border">
                                    ...
                                    <ol className="text-sm space-y-2 text-muted-foreground list-decimal pl-4">
                                        <li>Tạo bot qua <span className="text-foreground dark:text-zinc-50">@BotFather</span> để lấy Token.</li>
                                        <li>Thêm bot vào nhóm và lấy <span className="text-foreground dark:text-zinc-50">Chat ID</span> (Dùng bot @userinfobot hoặc @getidsbot).</li>
                                        <li>Nhấn <span className="text-foreground dark:text-zinc-50">Lưu cấu hình</span> để bắt đầu nhận thông báo.</li>
                                    </ol>
                                </div>
                                ...
                                <div className="pt-6 border-t border-border flex flex-col sm:flex-row gap-4 justify-end">
                                    ...
                                    >
                                        {isTestingTelegram ? <LoadingSpinner size="sm" className="mr-2" /> : <Send className="h-4 w-4" />}
                                        Gửi tin nhắn thử
                                    </Button>
                                    <Button onClick={handleSaveTelegram} disabled={isSavingTelegram} className="font-bold h-11 px-8 rounded-md">
                        ...
                        <Card className="rounded-md border-border overflow-hidden">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <CardTitle className="text-xl">Cổng thanh toán</CardTitle>
                                        <CardDescription className="text-sm font-medium">
                            ...
                            <CardContent className="space-y-8 pt-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <Button
                                                ...
                                                variant="outline"
                                                size="sm"
                                                className="h-11 px-3 rounded-md border-input text-xs shrink-0"
                                                onClick={async () => {
                                ...
                                <div className="p-5 bg-muted/50 rounded-md border space-y-4">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button size="sm" variant="outline" className="px-4 rounded-md text-xs border-input" onClick={() => {
                                            const url = `${window.location.origin}/api/webhooks/sepay`
                                            navigator.clipboard.writeText(url)
                                            toast.success('Đã copy Webhook URL')
                                        }}>Copy</Button>
                                    </div>
                                    <p className="text-[11px] text-muted-foreground leading-relaxed">Cấu hình URL này vào trang Dashboard SePay để tự động khớp tiền và gửi tin nhắn Telegram.</p>
                                </div>
                        ...
                        <Card className="rounded-md border-border overflow-hidden">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <CardTitle className="text-xl">Tulie Academy</CardTitle>
                                        <CardDescription className="text-sm font-medium">
                                        ...
                                        <div className="flex-1 space-y-3">
                                            ...
                                            <div className="space-y-1.5">
                                                ...
                                                <Input
                                                    ...
                                                    className="text-xs border-border dark:border-zinc-800 rounded-md"
                                                />
                                            </div>
                                        </div>
                                        <Button size="sm" variant="outline" className="font-semibold border-input" onClick={() => {
                                            const url = `${window.location.origin}/api/webhooks/academy`
                                            navigator.clipboard.writeText(url)
                                            toast.success('Đã copy Academy Webhook URL')
                                        }}>Copy</Button>
                                    </div>
                                    <p className="text-[11px] text-muted-foreground leading-relaxed">Dùng khóa này cấu hình vào Tulie Academy để đẩy dữ liệu doanh thu về CRM.</p>
                                </div>
                    ...
                    <TabsContent value="mail">
                        <Card className="rounded-md border-border overflow-hidden">
                            ...
                            <CardContent className="space-y-6 pt-6">
                                ...
                                <div className="flex items-center space-x-3 p-4 border border-border rounded-md bg-muted/30">
                                    <Switch
                                        id="smtp_secure"
                                        checked={smtpConfig.secure}
                                        onCheckedChange={val => setSmtpConfig({ ...smtpConfig, secure: val })}
                                    />
                                    <Label htmlFor="smtp_secure" className="text-sm text-foreground cursor-pointer">Sử dụng SSL/TLS (Tắt nếu dùng Port 587 STARTTLS)</Label>
                                </div>
                                ...
                                <div className="pt-6 border-t border-border flex flex-col sm:flex-row gap-4 justify-end">
                                    <Button
                                        ...
                                        className="font-bold h-11 px-6 rounded-md border-input"
                                    >
                                        {isTestingSmtp ? <LoadingSpinner size="sm" className="mr-2" /> : <Send className="h-4 w-4" />}
                                        Gửi email thử
                                    </Button>
                                    <Button onClick={handleSaveSmtp} disabled={isSavingSmtp} className="font-bold h-11 px-8 rounded-md">
                            ...
                            <CardContent className="space-y-0 divide-y divide-border/50">
                                <div className="flex items-center justify-between py-6">
                                    <div className="space-y-1">
                                        <Label className="text-sm text-foreground">Thông báo trong app</Label>
                                ...
                                <div className="flex items-center justify-between py-6">
                                    <div className="space-y-1">
                                        <Label className="text-sm text-foreground">Email thông báo</Label>
                                        <p className="text-sm text-muted-foreground font-medium">
                                ...
                                <div className="flex items-center justify-between py-6">
                                    <div className="space-y-1">
                                        <Label className="text-sm text-foreground">Cảnh báo hóa đơn quá hạn</Label>
                                        <p className="text-sm text-muted-foreground font-medium">
                                ...
                                <div className="flex items-center justify-between py-6">
                                    <div className="space-y-1">
                                        <Label className="text-sm text-foreground">Báo giá được xem</Label>
                                        <p className="text-sm text-muted-foreground font-medium">
                    ...
                    <TabsContent value="appearance">
                        <Card className="rounded-md border-border overflow-hidden">
                            ...
                            <CardContent className="space-y-0 divide-y divide-border/50">
                                <div className="flex items-center justify-between py-6">
                                    <div className="space-y-1">
                                        <Label className="text-sm text-foreground">Chế độ tối</Label>
                                        <p className="text-sm text-muted-foreground font-medium">
                                ...
                                <div className="flex items-center justify-between py-6">
                                    <div className="space-y-1">
                                        <Label className="text-sm text-foreground">Sidebar thu gọn</Label>
                                        <p className="text-sm text-muted-foreground font-medium">
                    ...
                    <TabsContent value="security">
                        <Card className="rounded-md border-border overflow-hidden">
                            ...
                            <CardContent className="space-y-6 pt-6">
                                ...
                                <Separator className="bg-border/50" />
                                <div className="flex justify-end pt-2">
                                    <Button className="rounded-md px-8 h-11">Đổi mật khẩu</Button>
                                </div>
                            </CardContent>
                        </Card>
                    </TabsContent>
                    ...
                    <TabsContent value="data">
                        <Card className="rounded-md border-border overflow-hidden">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                <CardTitle className="text-xl">Quản lý dữ liệu</CardTitle>
                                <CardDescription className="text-sm font-medium">
                            ...
                            <CardContent className="divide-y divide-border/50 p-0">
                                <div className="flex items-center justify-between p-6 hover:bg-muted/10 transition-colors">
                                    <div className="space-y-1">
                                        <Label className="text-sm text-foreground">Xuất dữ liệu toàn bộ</Label>
                                        <p className="text-sm text-muted-foreground font-medium">
                                ...
                                <div className="flex items-center justify-between p-6 hover:bg-muted/10 transition-colors">
                                    <div className="space-y-1">
                                        <Label className="text-sm text-foreground">Nhập dữ liệu khách hàng</Label>
                                        <p className="text-sm text-muted-foreground font-medium">
                    ...
                    <TabsContent value="bundles">
                        <Card className="rounded-md border-border overflow-hidden">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                <CardTitle className="text-xl">Bộ chứng từ (Document Bundles)</CardTitle>
                                <CardDescription className="text-sm font-medium">
                                    Thiết lập các nhóm mẫu giấy tờ để tự động hóa quy trình hợp đồng & báo giá.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-8 pt-6">
                                <div className="space-y-6 p-6 border border-border rounded-md bg-muted/20 ">
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className="h-8 w-8 rounded-lg bg-zinc-950 flex items-center justify-center ">
                                            <Plus className="h-4 w-4 text-white" />
                                        </div>
                                        <h4 className="text-base text-foreground">Thiết lập bộ mẫu mới</h4>
                                    </div>
                                                ...
                                                <div
                                                    ...
                                                    className={cn(
                                                        ...
                                                        newBundle.templates.includes(t.id)
                                                            ? "bg-zinc-950 text-white border-zinc-950  ring-2 ring-zinc-950 ring-offset-2"
                                                            : "bg-white border-border hover:border-zinc-400 hover:"
                                                    )}
                                                    onClick={() => {
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <h4 className="text-base text-foreground">Danh sách Bộ mẫu hiện có ({bundles.length})</h4>
                                    </div>
                                                ...
                                                <CardContent className="p-5">
                                                    <div className="flex flex-wrap gap-2">
                                                        {bundle.templates.map(tid => {
                                                            ...
                                                            return (
                                                                <Badge key={tid} variant="secondary" className="text-[11px] px-3 py-1 rounded-lg bg-muted border-transparent text-zinc-700 hover:bg-muted transition-colors">
                                        ...
                                        {bundles.length === 0 && (
                                            <div className="col-span-full py-16 text-center bg-muted/20 border-2 border-dashed border-border rounded-md">
                                                <div className="flex flex-col items-center gap-3">
                                                    <BookOpen className="w-10 text-zinc-200" />
                                                    <div className="space-y-1">
                            ...
                            <Card className="rounded-md border-border">
                                <CardHeader className="bg-muted/30 border-b border-border">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <CardTitle className="text-xl">Tài khoản công ty</CardTitle>
                                ...
                                <CardContent className="space-y-4 pt-6">
                                    ...
                                    >
                                        <Plus className="h-4 w-4" /> Thêm tài khoản công ty
                                    </Button>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="rounded-md border-border">
                                <CardHeader className="bg-muted/30 border-b border-border">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <CardTitle className="text-xl">Tài khoản cá nhân</CardTitle>
                                ...
                                <CardContent className="space-y-4 pt-6">
                                    ...
                                    >
                                        <Plus className="h-4 w-4" /> Thêm tài khoản cá nhân
                                    </Button>
                                </CardContent>
                            </Card>
                    ...
                    <TabsContent value="note-templates">
                        <Card className="rounded-md border-border">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                <CardTitle className="text-xl">Mẫu Ghi chú & Điều khoản</CardTitle>
                            ...
                            <CardContent className="space-y-6 pt-6">
                                <div className="space-y-6">
                                    ...
                                    >
                                        <Plus className="h-4 w-4" /> Thêm mẫu văn bản
                                    </Button>
                                </div>
