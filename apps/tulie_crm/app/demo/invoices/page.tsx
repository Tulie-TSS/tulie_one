        ...
        <div className="space-y-6">
            <div className="flex items-center gap-3">
                <div className="h-12 w-12 rounded-md bg-muted dark:bg-zinc-800 flex items-center justify-center shadow-sm border border-border">
                    <Receipt className="h-6 w-6 text-foreground dark:text-zinc-100" />
                </div>
                <div>
                    <h1 className="text-3xl font-bold text-foreground dark:text-zinc-50">Hóa đơn</h1>
                            ...
                            <Link key={inv.id} href={`/demo/invoices/${inv.id}`} className="block">
                                <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 px-5 py-4 hover:bg-muted/50 dark:hover:bg-zinc-800/50 transition-colors items-center cursor-pointer">
                                    ...
                                    <div className="col-span-2">
                                        <p className="text-sm font-semibold text-foreground dark:text-zinc-50">{inv.customerName}</p>
                                    </div>
                                    <div className="col-span-3">
                                        <p className="text-xs font-medium text-muted-foreground dark:text-muted-foreground truncate">{inv.description}</p>
                                    </div>
                                    <div className="col-span-2">
