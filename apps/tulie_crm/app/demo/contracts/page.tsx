        ...
        <div className="space-y-6">
            <div className="flex items-center gap-3">
                <div className="h-12 w-12 rounded-md bg-muted dark:bg-zinc-800 flex items-center justify-center shadow-sm border border-border">
                    <FilePenLine className="h-6 w-6 text-foreground dark:text-zinc-100" />
                </div>
                <div>
                    <h1 className="text-3xl font-bold text-foreground dark:text-zinc-50">Hợp đồng</h1>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-md border border-border overflow-hidden">
                ...
                <div className="divide-y divide-border/50">
                    {CONTRACTS.map((c) => {
                        ...
                        return (
                            <div key={c.id} className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 px-5 py-4 hover:bg-muted/50 dark:hover:bg-zinc-800/50 transition-colors items-center">
                                <div className="col-span-1">
                                    <span className="text-xs font-mono font-semibold text-muted-foreground">{c.id}</span>
                                </div>
                                <div className="col-span-3">
                                    <p className="text-sm font-semibold text-foreground dark:text-zinc-50">{c.project}</p>
                                ...
                                <div className="col-span-2 space-y-1">
                                    <p className="text-sm font-bold text-foreground dark:text-zinc-50">{formatCurrency(c.value)}</p>
