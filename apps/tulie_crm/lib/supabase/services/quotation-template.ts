...
<div style="font-family: 'Inter', -apple-system, sans-serif; font-size: 11pt; line-height: 1.6; color: #000; max-width: 800px; margin: 0 auto; padding: 20mm 15mm 20mm 25mm; text-align: justify;">
    ...
    <table style="width:100%; border-collapse:collapse; margin-bottom:12px; font-size:8pt;">
      ...
      <tr style="background:#f5f5f5;">
        <td style="border:1px solid #000; padding:4px;" colspan="8"><strong>Cộng tiền hàng / Subtotal</strong></td>
      ...
      {{discount_row_html}}
      <tr style="background:#f5f5f5;">
        <td style="border:1px solid #000; padding:4px;" colspan="8"><strong>Tổng tiền thanh toán / Grand Total</strong></td>
        <td style="border:1px solid #000; padding:4px;"></td>
        <td style="border:1px solid #000; padding:4px;"></td>
