            ...
            if (items.length > 0) {
                ...
                sectionEntries.forEach(([sectionName, sectionItems], sIdx) => {
                    ...
                    sectionItems.forEach((item: any, iIdx: number) => {
                        ...
                        (const const itemVatRate = (item.vat_percent !== undefined && item.vat_percent !== null) =item.vat_percent !== undefined && item.vat_percent !== null) ? item.vat_percent : (contract.quotation?.vat_percent || 0)
